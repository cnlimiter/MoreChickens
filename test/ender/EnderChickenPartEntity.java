...
public class EnderChickenPartEntity extends net.minecraftforge.entity.PartEntity<EnderChickenEntity> {
    public final EnderChickenEntity parentMob;
    public final String name;
    private final EntitySize size;

    public EnderChickenPartEntity(EnderChickenEntity p_i50232_1_, String p_i50232_2_, float p_i50232_3_, float p_i50232_4_) {
        super(p_i50232_1_);
