...
public class ScreenCollector extends AbstractContainerScreen<ContainerCollector> {
    private static final ResourceLocation CONTAINER_BACKGROUND = new ResourceLocation("textures/gui/container/generic_54.png");

    public ScreenCollector(ContainerCollector p_i51105_1_, Inventory p_i51105_2_, Component p_i51105_3_) {
