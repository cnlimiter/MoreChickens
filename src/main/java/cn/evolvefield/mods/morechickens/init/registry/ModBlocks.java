...
//                blockItem(manaSieve, optionalItemProperties(BotaniaCompat.MOD_ID))
    ...
    private static Item blockItem(Block block) {
        return blockItem(block, new Item.Properties().tab(ModTab.INSTANCE));
    }
    ...
    private static Item toBreederItem() {
        return new CustomRendererBlockItem(BLOCK_BREEDER, new Item.Properties().tab(ModTab.INSTANCE)) {
            @OnlyIn(Dist.CLIENT)
            @Override
    ...
    private static Item toRoostItem() {
        return new CustomRendererBlockItem(BLOCK_ROOST, new Item.Properties().tab(ModTab.INSTANCE)) {
            @OnlyIn(Dist.CLIENT)
            @Override
            public ItemRenderer createItemRenderer() {
