...
//    public static final RegistryObject<EntityType<CustomChickenEntityApi>> CUSTOM_CHICKEN = ENTITIES.register("custom_chicken",
//            () -> EntityType.Builder.of(CustomChickenEntityApi::new, EntityClassification.CREATURE).sized(0.375f, 0.625f)
//                    .build(new ResourceLocation(MoreChickens.MODID, "custom_chicken").toString()));
    ...
    public static void registerPlacements() {
        ...
        //EntitySpawnPlacementRegistry.register(CUSTOM_CHICKEN.get(), EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, AnimalEntity::checkAnimalSpawnRules);
