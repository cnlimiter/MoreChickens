...
public class ModItems {
    ...
    public static void registerItems(RegistryEvent.Register<Item> event) {
        ...
        registry.registerAll(
                ...
                WHITE_EGG = new ColorEggItem(new Item.Properties().tab(ModTab.INSTANCE),
                        10,
                        1000,
                        "dye_white",
                        "chickens:egg_white")
                        .setRegistryName("egg_white"),
                BLUE_EGG = new ColorEggItem(new Item.Properties().tab(ModTab.INSTANCE),
                        10,
                        1000,
                        "dye_blue",
                        "chickens:egg_blue")
                        .setRegistryName("egg_blue"),
                BLACK_EGG = new ColorEggItem(new Item.Properties().tab(ModTab.INSTANCE),
                        10,
                        1000,
                        "dye_black",
                        "chickens:egg_black")
                        .setRegistryName("egg_black"),
                MAGENTA_EGG = new ColorEggItem(new Item.Properties().tab(ModTab.INSTANCE),
                        10,
                        1000,
                        "dye_magenta",
                        "chickens:egg_magenta")
                        .setRegistryName("egg_magenta"),
                LIME_EGG =new ColorEggItem(new Item.Properties().tab(ModTab.INSTANCE),
                        10,
                        1000,
                        "dye_lime",
                        "chickens:egg_lime")
                        .setRegistryName("egg_lime"),
                YELLOW_EGG = new ColorEggItem(new Item.Properties().tab(ModTab.INSTANCE),
                        10,
                        1000,
                        "dye_yellow",
                        "chickens:egg_yellow")
                        .setRegistryName("egg_yellow"),
                PURPLE_EGG = new ColorEggItem(new Item.Properties().tab(ModTab.INSTANCE),
                        10,
                        1000,
                        "dye_purple",
                        "chickens:egg_purple")
                        .setRegistryName("egg_purple"),
                GREEN_EGG = new ColorEggItem(new Item.Properties().tab(ModTab.INSTANCE),
                        10,
                        1000,
                        "dye_green",
                        "chickens:egg_green")
                        .setRegistryName("egg_green"),
                LIGHT_GRAY_EGG = new ColorEggItem(new Item.Properties().tab(ModTab.INSTANCE),
                        10,
                        1000,
                        "dye_light_gray",
                        "chickens:egg_light_gray")
                        .setRegistryName("egg_light_gray"),
                LIGHT_BLUE_EGG = new ColorEggItem(new Item.Properties().tab(ModTab.INSTANCE),
                        10,
                        1000,
                        "dye_light_blue",
                        "chickens:egg_light_blue")
                        .setRegistryName("egg_light_blue"),
                CYAN_EGG = new ColorEggItem(new Item.Properties().tab(ModTab.INSTANCE),
                        10,
                        1000,
                        "dye_cyan",
                        "chickens:egg_cyan")
                        .setRegistryName("egg_cyan"),
                RED_EGG = new ColorEggItem(new Item.Properties().tab(ModTab.INSTANCE),
                        10,
                        1000,
                        "dye_red",
                        "chickens:egg_red")
                        .setRegistryName("egg_red"),
                PINK_EGG =new ColorEggItem(new Item.Properties().tab(ModTab.INSTANCE),
                        10,
                        1000,
                        "dye_pink",
                        "chickens:egg_pink")
                        .setRegistryName("egg_pink"),
                ORANGE_EGG =new ColorEggItem(new Item.Properties().tab(ModTab.INSTANCE),
                        10,
                        1000,
                        "dye_orange",
                        "chickens:egg_orange")
                        .setRegistryName("egg_orange"),
                GRAY_EGG = new ColorEggItem(new Item.Properties().tab(ModTab.INSTANCE),
                        10,
                        1000,
                        "dye_gray",
                        "chickens:egg_gray")
                        .setRegistryName("egg_gray"),
                BROWN_EGG = new ColorEggItem(new Item.Properties().tab(ModTab.INSTANCE),
                        10,
                        1000,
                        "dye_brown",
                        "chickens:egg_brown")
                        .setRegistryName("egg_brown"),
                CHICKEN_SPAWN_EGG = new ModSpawnEgg(ModEntities.BASE_CHICKEN, 0x734011, 0xa4b5bd, new Item.Properties().tab(ModTab.INSTANCE)).setRegistryName("chicken_spawn_egg"),
                WATER_EGG = new BallItem(new Item.Properties().tab(ModTab.INSTANCE), Fluids.WATER).setRegistryName("egg_water"),
                LAVA_EGG = new BallItem(new Item.Properties().tab(ModTab.INSTANCE), Fluids.LAVA).setRegistryName("egg_lava"),
                ITEM_CATCHER,
                ITEM_CHICKEN ,
                ANALYZER
    ...
    private static Item.Properties itemProperties() {
        return new Item.Properties().tab(ModTab.INSTANCE);
    }

    private static Item.Properties optionalItemProperties(String modId) {
        Item.Properties properties = new Item.Properties();
        if (ModList.get().isLoaded(modId)) {
            return properties.tab(ModTab.INSTANCE);
        }
