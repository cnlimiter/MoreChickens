...
////////////////////////////////
    ...
    // Primary dyes
        ...
        DIAMOND = new ChickenType("diamond", "minecraft:diamond", 1, 0, 18000),
        ...
        PRISM_SHARD = new ChickenType("prism_shard", "minecraft:prismarine_shard", 1, 3, 18000, "minecraft:prismarine_crystals", 2),
        PRISM_CRYSTALS = new ChickenType("prism_crystals", "minecraft:prismarine_crystals", 1, 3, 18000),
