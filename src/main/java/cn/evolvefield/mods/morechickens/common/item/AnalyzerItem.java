...
public class AnalyzerItem extends Item {
    ...
    public InteractionResult interactLivingEntity(ItemStack stack, Player playerIn, LivingEntity target, InteractionHand hand) {
        ...
        if(!(target instanceof BaseChickenEntity))
            return InteractionResult.FAIL;
        BaseChickenEntity chicken = (BaseChickenEntity) target;
        Gene gene = chicken.getGene();
        TranslatableComponent name=new TranslatableComponent("text." + MoreChickens.MODID + ".name." + chicken.getChickenName());
